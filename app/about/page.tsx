        ...
        <div className="grid md:grid-cols-[1fr_260px] gap-12 items-start">
          ...
          <GsapReveal direction="up">
            <article className="prose prose-invert prose-neutral max-w-none prose-p:leading-loose prose-p:text-neutral-400 prose-a:text-blue-400 hover:prose-a:text-blue-300">
              <p>
                你好！我是 Mark xu，目前是一名 SPTC
                的大二在读生。虽然主修<strong>电子信息工程</strong>
                ，但我对计算机科学与软件架构有着极大的热情。
              </p>
              <p>
                我的编程之旅始于对互联网的好奇，目前正在系统自学 UESTC
                的计算机科学学位相关课程。在中职时期，我沉淀了扎实的计算机基础，现在我的核心重心聚焦于{" "}
                <strong>Web3 前端开发</strong>、<strong>分布式系统</strong>{" "}
                与去中心化基础设施的探索。
              </p>
              <p>
                我深耕 Next.js 生态与 AI Agent
                的垂直落地应用，擅长将业务逻辑抽象并转化为高性能、高可用且极致流畅的现代化前端交互体验。近期正在重点探索基于{" "}
                <code>Blockchain</code>{" "}
                的去中心化身份（DID）与前端无缝结合的解决方案。
              </p>
          ...
          {/* 右侧边栏 */}
          <GsapStagger className="flex flex-col gap-4" stagger={0.15} delay={0.2}>
            {/* 头像小卡片 */}
            <div className="p-4 rounded-2xl bg-neutral-900/40 border border-neutral-800/60 flex flex-col items-center text-center">
              ...
              <Link
                ...
                className="w-full py-2 px-4 rounded-xl bg-blue-600/10 text-blue-500 hover:bg-blue-600/20 text-sm font-medium transition-colors border border-blue-500/20"
              >
                联系我
              </Link>
            </div>
